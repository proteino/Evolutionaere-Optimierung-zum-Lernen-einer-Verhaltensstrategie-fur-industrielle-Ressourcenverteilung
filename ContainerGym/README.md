...
📦containergym
 ...
 ┣ 📂models
   ┃ 📜linear_proc_unit_models.py -> PU models for emptying containers
...
```
 python3 -m containergym.playground.train_agent --config-file 1container_1proc_unit.json --budget 100000 --n-steps 2048 --RL-agent PPO --n-seeds 1
```
### 📊 Evaluation

```
python3 -m containergym.playground.evaluate_agent --config-file 1container_1proc_unit.json --budget 100000 --n-steps 2048 --RL-agent PPO --n-seeds 1 --render-episode True 
```
