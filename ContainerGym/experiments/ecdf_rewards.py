...
def episodic_reward(
    ...
    config_file: str, optional
        name of the config file used for the environment, by default '1container_1proc_unit.json'
...
def produce_ecdf_rewards():
    ...
    fig_format = "svg"
    paths = [
        "./logs_best_seeds/ppo_11containers_11proc_units_5_seed_3_budget_5000000_ent-coef_0.0_gamma_0.99_steps_6144",
        "./logs_best_seeds/trpo_11containers_11proc_units_5_seed_4_budget_5000000_gamma_0.99_steps_6144",
        "./logs_best_seeds/dqn_11containers_11proc_units_5_seed_10_budget_5000000_gamma_0.99",
    ]
    ...
    for i, config_file in enumerate(["5containers_2proc_units_2.json", "11containers_2proc_units_3.json",
                                     "11containers_11proc_units_5.json"]):
        print(labels[i])
